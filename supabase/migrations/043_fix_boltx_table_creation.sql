-- ============================================================================
-- Fix BoltX Configurations Table Creation
-- ============================================================================
-- This migration ensures the analytics.boltx_configurations table exists
-- and the RPC functions are properly created in the public schema
