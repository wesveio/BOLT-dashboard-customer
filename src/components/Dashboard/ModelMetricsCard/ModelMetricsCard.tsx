        ...
        <Card className="border border-default hover:border-primary/20 hover:shadow-lg transition-all duration-200">
          <CardBody className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl font-bold text-foreground">Model Performance</h3>
      ...
      <Card className="border border-default hover:border-primary/20 hover:shadow-lg transition-all duration-200">
        <CardBody className="p-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            ...
            <div>
              <p className="text-sm text-foreground/70 mb-1">Precision</p>
              <p className="text-2xl font-bold text-foreground">
                {formatPercentage(metrics.precision * 100)}
              </p>
            </div>
            <div>
              <p className="text-sm text-foreground/70 mb-1">Recall</p>
              <p className="text-2xl font-bold text-foreground">
                {formatPercentage(metrics.recall * 100)}
              </p>
            </div>
            <div>
              <p className="text-sm text-foreground/70 mb-1">F1 Score</p>
              <p className="text-2xl font-bold text-foreground">
          ...
          <div className="pt-4 border-t border-default">
            <div className="flex items-center justify-between text-sm">
              <span className="text-foreground/70">Training Size</span>
              <span className="font-semibold text-foreground">{metrics.trainingSize.toLocaleString()} sessions</span>
            </div>
            <div className="flex items-center justify-between text-sm mt-2">
              <span className="text-foreground/70">Last Trained</span>
              <span className="text-foreground">{lastTrainedText}</span>
            </div>
          </div>
        </CardBody>
      </Card>
