...
export function FilterBar({
  ...
  return (
    <div
      className={`bg-default-50 border border-default-200 rounded-lg p-4 flex flex-col md:flex-row md:flex-wrap items-stretch md:items-center gap-3 ${className}`}
    >
      {/* Time Period Filter */}
      ...
      <div className="flex items-center gap-2 w-full md:w-auto md:flex-shrink-0">
        <TagIcon className="w-5 h-5 text-foreground/50 flex-shrink-0" />
        <Select
      ...
      {/* Event Type Filter */}
      <div className="flex items-center gap-2 w-full md:w-auto md:flex-shrink-0">
        <FunnelIcon className="w-5 h-5 text-foreground/50 flex-shrink-0" />
        <Select
      ...
      {onRefresh && (
        <Button
          ...
          onPress={onRefresh}
          size="sm"
          className="w-full md:w-auto md:ml-auto border-primary/20 hover:border-primary/40 hover:bg-primary/10 transition-all duration-200 font-semibold"
        >
          {t('refresh')}
        </Button>
      )}
