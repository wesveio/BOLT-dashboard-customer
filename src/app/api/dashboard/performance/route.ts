...
export async function GET(_request: NextRequest) {
  try {
    ...
    if (isDemo) {
      console.info('✅ [DEBUG] Account in demo mode, returning mock performance data');
      const mockData = await getMockDataFromRequest('performance', user.account_id, _request);
