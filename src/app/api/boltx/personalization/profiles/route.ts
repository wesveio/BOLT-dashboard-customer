...
export async function GET(request: NextRequest) {
  try {
    ...
    if (isDemo) {
      console.info('✅ [DEBUG] Account in demo mode, returning mock personalization profiles');
      const mockData = await getMockDataFromRequest('boltx-personalization-profiles', user.account_id, request);
